...
class AviatorStartAPPVCPage: UIViewController {
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        ...
        if isStarSelected {
            clearAllStars()
            AviatorAlterUtils.showAlert(title: "Thanks for feedback", message: "Your feedback added successfully", from: self)
        } else {
            AviatorAlterUtils.showAlert(title: "No Selection", message: "Please select a rating before submitting.", from: self)
        }
    }
