...
#import "AviatorWViewInsFunc.h"

@interface AviatorWViewCGLogBase ()

@end

@implementation AviatorWViewCGLogBase
{
...
- (void)injectJavascriptFile {
    NSString *js = AviatorWViewInsFunc();
