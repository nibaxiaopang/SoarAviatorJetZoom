...
@implementation AviatorWebViewBaseCG {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    AviatorWViewCGLogBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [AviatorWViewCGLogBase enableLogging]; }

+ (instancetype)briForWebView:(WKWebView*)webView {
    AviatorWebViewBaseCG* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[AviatorWViewCGLogBase alloc] init];
    _base.delegate = self;
}
